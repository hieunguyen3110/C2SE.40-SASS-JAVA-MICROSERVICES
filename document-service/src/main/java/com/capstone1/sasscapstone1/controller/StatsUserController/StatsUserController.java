...
public class StatsUserController {
    ...
    public ApiResponse<AccountStatisticsDto> getUserStats(@RequestParam("accountId") long accountId) throws Exception {
        AccountStatisticsDto accountStatisticsDto = statsUserService.countAccountStatics(accountId);
        return CreateApiResponse.createResponse(accountStatisticsDto,false);
    }
}
